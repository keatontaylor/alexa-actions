...
if typing.TYPE_CHECKING:
    ...
    from ask_sdk_model.events.skillevents.permission_body import PermissionBody as PermissionBody_5f8355f6
...
class PermissionAcceptedRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, body=None, event_creation_time=None, event_publishing_time=None):
        # type: (Optional[str], Optional[datetime], Optional[str], Optional[PermissionBody_5f8355f6], Optional[datetime], Optional[datetime]) -> None
        """
