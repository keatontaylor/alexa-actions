...
class BodyTemplate3(Template):
    ...
    def __init__(self, token=None, back_button=None, background_image=None, image=None, title=None, text_content=None):
        # type: (Optional[str], Optional[BackButtonBehavior_46c3eb02], Optional[Image_1942d978], Optional[Image_1942d978], Optional[str], Optional[TextContent_1d3959d5]) -> None
        """
