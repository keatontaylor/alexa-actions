...
class StorageLimitExeceededError(CommandsError):
    """
    ...
    def __init__(self, content=None):
        ...
        :type content: (optional) ask_sdk_model.interfaces.alexa.datastore.execution_error_content.ExecutionErrorContent
        """
        self.__discriminator_value = "STORAGE_LIMIT_EXCEEDED"  # type: str

        self.object_type = self.__discriminator_value
        super(StorageLimitExeceededError, self).__init__(object_type=self.__discriminator_value)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageLimitExeceededError):
            return False
