...
if typing.TYPE_CHECKING:
    ...
    from ask_sdk_model.interfaces.alexa.datastore.packagemanager.error_type import ErrorType as ErrorType_68078ba6
...
class PackageError(object):
    ...
    """
    deserialized_types = {
        'object_type': 'ask_sdk_model.interfaces.alexa.datastore.packagemanager.error_type.ErrorType',
        'content': 'object'
    }  # type: Dict
    ...
    def __init__(self, object_type=None, content=None):
        # type: (Optional[ErrorType_68078ba6], Optional[object]) -> None
        """Additional information about the package installation/update error.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PackageError):
            return False
