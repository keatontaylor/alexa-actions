...
class UpdateRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, package_id=None, from_version=None, to_version=None):
        # type: (Optional[str], Optional[datetime], Optional[str], Optional[str], Optional[str], Optional[str]) -> None
        """This event is request sent by device DataStore Package Manager asking the skill developer them to update the version of the package on device.
        ...
        :type to_version: (optional) str
        """
        self.__discriminator_value = "Alexa.DataStore.PackageManager.UpdateRequest"  # type: str

        self.object_type = self.__discriminator_value
        super(UpdateRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)
