...
class CommandsError(object):
    ...
    discriminator_value_class_map = {
        'DEVICE_UNAVAILABLE': 'ask_sdk_model.interfaces.alexa.datastore.device_unavailable_error.DeviceUnavailableError',
        'DEVICE_PERMANENTLY_UNAVAILABLE': 'ask_sdk_model.interfaces.alexa.datastore.device_permanantly_unavailable_error.DevicePermanantlyUnavailableError',
        'DATASTORE_INTERNAL_ERROR': 'ask_sdk_model.interfaces.alexa.datastore.data_store_internal_error.DataStoreInternalError',
        'STORAGE_LIMIT_EXCEEDED': 'ask_sdk_model.interfaces.alexa.datastore.storage_limit_execeeded_error.StorageLimitExeceededError'
    }
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CommandsError):
            return False
