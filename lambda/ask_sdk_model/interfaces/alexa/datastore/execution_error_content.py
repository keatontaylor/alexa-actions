...
class ExecutionErrorContent(object):
    """
    ...
    deserialized_types = {
        'device_id': 'str',
        'failed_command': 'ask_sdk_model.services.datastore.v1.command.Command',
        'message': 'str'
    }  # type: Dict
    ...
    def __init__(self, device_id=None, failed_command=None, message=None):
        # type: (Optional[str], Optional[Command_6778502c], Optional[str]) -> None
        """Content of an execution error.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExecutionErrorContent):
            return False
