...
if typing.TYPE_CHECKING:
    ...
    from ask_sdk_model.interfaces.alexa.presentation.aplt.position import Position as Position_deacabdc
...
class SetPageCommand(Command):
    ...
    def __init__(self, delay=None, description=None, screen_lock=None, when=None, component_id=None, position=None, value=None):
        # type: (Optional[int], Optional[str], Optional[bool], Union[bool, str, None], Optional[str], Optional[Position_deacabdc], Union[int, str, None]) -> None
        """Change the page displayed in a Pager component. The SetPage command finishes when the item is fully in view.
