...
class ReinflateCommand(Command):
    """
    ...
    def __init__(self, delay=None, description=None, screen_lock=None, sequencer=None, when=None):
        ...
        :type when: (optional) bool
        """
        self.__discriminator_value = "Reinflate"  # type: str

        self.object_type = self.__discriminator_value
        super(ReinflateCommand, self).__init__(object_type=self.__discriminator_value, delay=delay, description=description, screen_lock=screen_lock, sequencer=sequencer, when=when)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReinflateCommand):
            return False
