...
class HideOverlayCommand(Command):
    ...
    def __init__(self, delay=None, description=None, screen_lock=None, sequencer=None, when=None, overlay_layout_id=None, underlying_layout_id=None, overlay_width=None, duration=None):
        ...
        :type duration: (optional) int
        """
        self.__discriminator_value = "HideOverlay"  # type: str

        self.object_type = self.__discriminator_value
        super(HideOverlayCommand, self).__init__(object_type=self.__discriminator_value, delay=delay, description=description, screen_lock=screen_lock, sequencer=sequencer, when=when)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HideOverlayCommand):
            return False
