...
from ask_sdk_model.services.datastore.v1.command import Command
...
class PutObjectCommand(Command):
    """
    ...
    def __init__(self, namespace=None, key=None, content=None):
        ...
        :type content: (optional) object
        """
        self.__discriminator_value = "PUT_OBJECT"  # type: str

        self.object_type = self.__discriminator_value
        super(PutObjectCommand, self).__init__(object_type=self.__discriminator_value)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PutObjectCommand):
            return False
