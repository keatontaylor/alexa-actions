...
class RemoveObjectCommand(Command):
    ...
    def __init__(self, namespace=None, key=None):
        ...
        :type key: (optional) str
        """
        self.__discriminator_value = "REMOVE_OBJECT"  # type: str

        self.object_type = self.__discriminator_value
        super(RemoveObjectCommand, self).__init__(object_type=self.__discriminator_value)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoveObjectCommand):
            return False
